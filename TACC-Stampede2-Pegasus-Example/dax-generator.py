...
#Add input file to the DAX-level replica catalog
dem = File("3083_5_9_100_103.tif")
dem.addPFN(PFN("file://" + os.getcwd() + "/3083_5_9_100_103.tif", "local"))
hand_model.addFile(dem)

e_pyd8 = Executable(namespace="hand_model", name="pyd8", installed=False)
e_pyd8.addPFN(PFN("file://" + os.getcwd() + "/pyd8.py", "local"))
hand_model.addExecutable(e_pyd8)

e_pyhand = Executable(namespace="hand_model", name="pyhand", installed=False)
e_pyhand.addPFN(PFN("file://" + os.getcwd() + "/pyhand.py", "local"))
hand_model.addExecutable(e_pyhand)

# Add left Findrange job
pyd8 = Job(namespace="hand_model", name="pyd8")
d8 = File("d8.tif")
...
pyd8.addProfile(Profile(Namespace.PEGASUS, key="cores", value="1"))
hand_model.addJob(pyd8)


# Add left Findrange job
pyhand = Job(namespace="hand_model", name="pyhand")
hand = File("hand.tif")
...
pyhand.addProfile(Profile(Namespace.PEGASUS, key="cores", value="1"))
